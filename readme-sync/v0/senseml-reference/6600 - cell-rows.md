...
| stop                     | [Match object](doc:match) or array of Match objects. default: none | Stops extraction at the end of the spreadsheet above the matched line. Excludes the row containing the matched line. |
