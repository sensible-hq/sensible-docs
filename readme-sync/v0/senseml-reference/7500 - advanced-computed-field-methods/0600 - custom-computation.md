...
| :----------------------- | :----------------------------------------- | :----------------------------------------------------------- |
| id (**required**)        | `customComputation`                        | This method has access to the  `parsed_document` object as follows: <br/>- where [verbosity](doc:verbosity) = 0<br/>- at a depth of 1 section, in the case of nested sections<br/><br/>This method operates on the following types: `string, number, boolean, null` , or on an array of those. It returns the same types. |
