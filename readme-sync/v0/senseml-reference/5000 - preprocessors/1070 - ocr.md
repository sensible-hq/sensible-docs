...
| engine                                                       | `amazon`,<br/>`google`,<br>`microsoft`,<br/>`lazarus`,<br/>default: The OCR engine specified in the document type. | Specifies the OCR engine for this preprocessor. This parameter overrides the document type's OCR engine for this config.<br/>Microsoft is the default engine specified when you create a document type, and is suited to typewritten and long documents.  Lazarus is faster than Microsoft and produces similar output.<br/>Google is faster than Microsoft and suited to handwriting and short documents (25 pages or under). <br/> The Google engine doesn't merge words into lines automatically. Use the Merge Lines preprocessor in your configurations to do so. <br/>Amazon is an alternative to experiment with if other engines aren't recognizing text. |
