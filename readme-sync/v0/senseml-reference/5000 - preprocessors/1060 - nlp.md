  ...
  "preprocessors": [
    {
      ...
      /* since one of the answers (pet breed) isn't contained in the ID card,
          ...
          */
      "query": {
        "promptIntroduction": "Answer the question as truthfully and concisely as possible using the provided context. If the answer is not contained within the text below, but you know the answer because of your general knowledge, then answer the question"
      }
    }
  ],
  "fields": [
    ...
    },
    {
      ...
      "method": {
        "id": "question",
        "question": "full name of the usa president who owned this pet"
      },
      "type": "string"
    },
    {
      ...
      "method": {
        "id": "question",
        "question": "pet breed. base your answer on your general knowledge of USA history"
      },
      "type": "string"
    },
  ]
...
For each Sensible Instruct method, Sensible creates a full prompt for a large-language method (LLM) that includes your prompts and *context*, or chunks excepted from a document. For information about configuring the full prompt that Sensible inputs to an LLM, see [Advanced prompt configuration](doc:prompt).
