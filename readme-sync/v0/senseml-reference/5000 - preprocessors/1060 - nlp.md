  ...
  "preprocessors": [
    {
      ...
      /* since one of the answers (pet breed) isn't contained in the ID card,
         ...
         by overriding the prompt introduction for each Query method in this config.
          */
      "query": {
