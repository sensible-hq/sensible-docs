...
Configures the full prompt for all [LLM-based](doc:prompt-tips) methods in a config. For information about configuring the full prompt, see [Advanced LLM prompt configuration](doc:prompt).
