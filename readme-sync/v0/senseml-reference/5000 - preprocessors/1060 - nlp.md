...
| ---------------------- | ------ | ------------------------------------------------------------ |
| type (**required**)    | `nlp`  |                                                              |
| query                  | object | Parameters:<br/>- `promptIntroduction`<br/>For more information about parameters, see [Query](doc:query#parameters) |
| nlpTable               | object | Parameters:<br/>- `promptIntroduction`<br/>- `rewriteTable`<br/>- `pageSpanThreshold`<br/>For more information about parameters, see [NLP Table](doc:nlp-table#parameters) |
| list                   | object | Parameters:<br/>- `promptIntroduction`<br/>- `llm_engine`<br/>For more information about parameters, see [List](doc:list#parameters) |
