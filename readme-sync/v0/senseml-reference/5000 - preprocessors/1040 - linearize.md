...
| match<br/>or<br/>range | [Match](doc:match) object or array of Match objects<br/>or<br/>Range object | Specifies the matching pages or repeating sections ("ranges") on which to run this preprocessor.<br/>`match`: TODO HOW TO FORMAT?<br/>or<br/>`range`:<br/> See following table |
...
| key                   | value                                              | description for horizontal sections                          | description  for LINEARIZED BLOCKS                           | description for vertical sections                            |
| --------------------- | -------------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
...
|                       |                                                    |                                                              |                                                              |                                                              |
| requireStop           | Boolean. default: false                            | If true, each section ends when it matches the Stop parameter, instead of the default behavior of ending at the next starting line specified in the anchor's Match parameter.<br/>**Note:**  Configure this parameter for horizontal sections when the starting line repeats in each section, to avoid ending each section before it completes.<br/>You don't need to configure this parameter for matches that are on the same horizontal line as the anchor's Match parameter. For more information, see [Multiple anchors in section](doc:section-nuances#multiple-anchors-in-section). |                                                              | not supported                                                |
|                       |                                                    |                                                              |                                                              |                                                              |
|                       |                                                    |                                                              |                                                              |                                                              |
|                       |                                                    |                                                              |                                                              |                                                              |
