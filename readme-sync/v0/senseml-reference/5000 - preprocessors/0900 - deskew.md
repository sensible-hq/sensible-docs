...
- If a document contains pages that are slightly rotated and otherwise untransformed, you don't need a preprocessor. Sensible's default OCR engine (Microsoft) corrects slight rotation automatically.
