...
| alwaysNegative     | boolean                                                      | If true, Sensible assigns a negative value to a number regardless of the sign in the source. For example, use this to capture the negative values in column-style accounting where the negative sign is absent. |
