...
| alwaysNegative     | boolean                                                      | If true, Sensible assigns a negative value to a number regardless of the sign in the document. For example, use this to capture the negative values in an debit accounting column where the negative sign is omitted. |
