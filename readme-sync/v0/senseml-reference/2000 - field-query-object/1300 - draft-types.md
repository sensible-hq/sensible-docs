...
| `%b\\%d\\%Y`         | JAN\31\2022                            | `"value": "2022-01-31T00:00:00.000Z"`  | You don't need to double escape special characters  (for example, Sensible accepts  `\s` , to represent a whitespace character). |
