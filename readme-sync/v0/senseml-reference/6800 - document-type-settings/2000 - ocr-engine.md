...
| enum      | description                                                  |
| --------- | ------------------------------------------------------------ |
| Amazon    | Default engine for the OCR preprocessor.<br/>Default engine for document types. |
| Microsoft | Suited to typewritten documents and large documents up to 50 MB in size. |
