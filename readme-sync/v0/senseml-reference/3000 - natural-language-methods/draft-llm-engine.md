...
2. Sensible selects a number of the top-scoring chunks: 
   ...
   2. If you select `llm_engine: fast`,   1. Sensible selects top-scoring chunks as determined by the Chunk Count parameter. 2. Sensible removes chunks that are significantly less relevant from the list of top-scoring chunks, to select a smaller number of chunks.
