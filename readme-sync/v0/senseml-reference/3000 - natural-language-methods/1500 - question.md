...
| pageHinting             | boolean                                                      | Includes or or removes page metadata for each chunk from the prompt Sensible inputs to an LLM. For example, removes phrases like `The excerpt starts at the top of page 1 and ends at the bottom of page 1.` |
