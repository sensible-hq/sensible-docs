...
| chunkSize              | `0.5, 1` default: `0.5`       | The size of the chunks Sensible splits the document into, in page height. `0.5` specifies each chunk is half a page, for example. For details about chunks, see the Notes section. |
