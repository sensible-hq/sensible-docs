...
| chunkCount             | number                        | The number of top-scoring chunks Sensible combines to as context for the question it poses to a large-language model (LLM). For details about chunks, see the Notes section. |
