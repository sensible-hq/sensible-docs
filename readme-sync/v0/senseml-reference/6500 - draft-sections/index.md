...
Use `"direction":"vertical"` to find text in column-like layouts, for example, to extract tables nested in tables, tables with row labels, or other complex text layouts. 
