...
| lineSelection   | Match object, or array of Match objects         | Use to include lines that span columns in each column. For example, to include a footnote that is applicable to each column. Each column then becomes irrgularly shaped in order to capture the lines. |
