...
- Zips the output of fields into an array of objects. Each source field must output an array, for example, as a result of configuring `"match": "all"` or `"type": "name"` for the field. 
