...
| chunkCount                          | integer. default: 20                | For information about this parameter, see [Advanced LLM prompt configuration](doc:prompt#parameters) |
| chunkSize                           | integer. default: 1                 | For information about this parameter, see [Advanced LLM prompt configuration](doc:prompt#parameters) |
| chunkOverlapPercentage              | integer. default: 0                 | For information about this parameter, see [Advanced LLM prompt configuration](doc:prompt#parameters) |
