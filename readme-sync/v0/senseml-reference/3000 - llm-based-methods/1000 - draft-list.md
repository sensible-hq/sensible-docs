...
| chunkSize                           | 1                                   | For information about this parameter, see [Advanced LLM prompt configuration](doc:prompt#parameters) |
| chunkOverlapPercentage              | 0                                   | For information about this parameter, see [Advanced LLM prompt configuration](doc:prompt#parameters) |
...
3. To avoid large language model (LLM)'s token limits, Sensible batches the chunks into groups by page numbers. Sensible batches a maxiumum of 20 page numbers. The chunks in each page group can be non-consecutive in the document.
