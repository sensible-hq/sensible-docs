...
- Sensible can output lists of different maximum lengths depending on how you configure the LLM Engine parameter. For more information, see [parameters](doc:list#parameters.). If the extracted list exceeds the limit, Sensible truncates the list.
