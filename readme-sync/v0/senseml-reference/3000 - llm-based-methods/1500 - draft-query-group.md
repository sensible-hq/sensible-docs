...
The following example shows how to prompt an LLM to answer questions about another field's output.
 ...
 use the output from other extracted fields as the [context](doc:prompt#notes) for new prompts, in order to transform data or ask questions about the original fields' output:
