...
| anchor (**required**) | object                                                       | The anchor identifies one or more lines of *text* in the document where we start method execution. Can be a string, [Match object](doc:anchor-object#section-match-object) or array of Match objects. |
