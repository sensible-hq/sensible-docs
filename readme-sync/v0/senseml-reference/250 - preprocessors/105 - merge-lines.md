...
| `minXGapThreshold`                         | number in inches                       | TODO: The amount of overlap in inches on the x-axis above/below which two lines that overlap on an x-axis are merged into one line. |
...
```
TODO: Overlapping lines on an x-axis
----
...
![](https://raw.githubusercontent.com/sensible-hq/sensible-docs/main/readme-sync/assets/v0/images/TBD_example.png)
