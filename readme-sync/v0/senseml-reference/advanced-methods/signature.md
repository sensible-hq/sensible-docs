...
[block:parameters]
{
  "data": {
    ...
    "0-1": "`signature`",
    "1-0": "start",
    "1-1": "[Direction](doc:direction), one of `above`, `below`, `left`, `right`",
    "1-2": "A [Direction](doc:direction) specifying where to start relative to the anchor point. `right` starts at the middle of the right edge, `below` starts at the middle of the bottom edge, and so forth",
    "2-0": "offsetX",
