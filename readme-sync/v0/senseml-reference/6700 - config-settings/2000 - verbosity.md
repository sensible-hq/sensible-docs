...
| :-------------- | :----------------------------------------------------------- |
| `0`             | default                                                      |
| `1`             | For single-document extractions, adds a `lines` array describing each field's source text, including its position in the document, to each field's output. Each line includes  `text`, `page`, and `boundingPoly` metadata. |
