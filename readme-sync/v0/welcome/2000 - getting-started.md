...
- [Validate extractions in production](doc:getting-started#validate-extractions-in-production) using logic to define the values you expect for fields, and flagging out-of-bound values as warnings or errors
