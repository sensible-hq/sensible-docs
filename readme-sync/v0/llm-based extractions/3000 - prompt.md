...
When you write a prompt in a LLM-based method, Sensible combines your prompt with other information to create the full prompt. The full prompt includes:
...
- concatenated descriptive prompts you configure in a LLM-based method, such as in the [List](doc:list-tips) or [Query Group](doc:query-group-tips) methods.
...
Global the visual editor parameters
===
...
| SenseML parameter                   | value                                                        | config-level description:<br/>configure in [NLP preprocessor](doc:nlp) or in the visual editor configuration settings | method-level description:<br/>configure in a field   |
| :---------------------------------- | :----------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------- |
