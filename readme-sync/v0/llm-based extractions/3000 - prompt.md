...
| SenseML parameter                   | value                                                        | config-level:<br/>configure in [NLP preprocessor](doc:nlp) or in the visual editor's configuration settings | method-level:<br/>configure in a field   |
| :---------------------------------- | :----------------------------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------------- |
