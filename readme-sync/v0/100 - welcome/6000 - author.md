...
As you scale up, you need to balance extraction performance, the the effort you put into writing extraction configurations, and the complexity of your documents. As part of this optimization, choose between LLMs or rules-based extraction methods.
