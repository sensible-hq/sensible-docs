...
7. In the **Set up action** section, map Sensible field names to the corresponding Airtable column, or field,  names. Zapier displays the data from the recent document extraction as examples. Use the following screenshot to complete the configuration:
