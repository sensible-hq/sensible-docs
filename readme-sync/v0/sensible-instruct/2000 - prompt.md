...
You can configure all of these parameters in the SenseML editor and several in the Sensible Instruct editor. For example, in Sensible Instruct, select a query field and click the Advanced settings icon in the prompt to access advanced settings for a Query field:
