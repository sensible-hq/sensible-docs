...
7. Click a new configuration to edit the SenseML and extract structured data from the PDF. For a tutorial, see [Getting started with layout-powered extractions](doc:getting-started).
