...
To try out the [extract\_from\_url](ref:extract-from-url) endpoint, let's use an example document hosted in GitHub:
...
1. Copy the following code sample and replace `*YOUR_API_KEY*` with your [API key](https://app.sensible.so/account/):
   ...
   --data-raw '{"document_url":"https://raw.githubusercontent.com/sensible-configuration-library/main/templates/Tax%20Forms/1040s/refdocs/1040_2021_sample.pdf"}'
   ```
...
2. In your Postman workspace, click **Import**, select **Raw text**, paste the code sample, and follow the prompts to import to code sample.
  ...
  ![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs-assets-temp/main/readme-sync/assets/v0/images/final/api_quickstart_postman_1.png)
