---
title: DONE email - Document type settings
excerpt: ''
deprecated: false
hidden: false
metadata:
...
* define document type here + config
* new sibiling topic (email processor settings) where you also define an email processor as defining a webhook, email alias, and doc types?
* LEFT OFF
