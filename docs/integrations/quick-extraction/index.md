...
metadata:
  title: ''
  description: Learn how to use Sensible app's Extract tab to upload documents in
    bulk and download extracted data as Excel files for custom or supported document
    types.
  robots: index
next:
  description: ''
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/quickstart_instruct_11.png)
...
| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/pdfs/bank_3.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------ |
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/quickstart_instruct_12.png)
