...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/zapier_action_1_slack.png)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/zapier_action_2_slack.png)
...
1. Create a test Slack channel. Name it `1040s_uploads`. Upload an [example 1040 document](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/pdfs/1040_2021_sample.pdf) to the channel.
...
3. For the action, take the following steps:
   ...
   4. Test:
      ...
      2. Navigate to the `1040s_extracted` Google Drive folder you created in a previous step and verify it now contains a spreadsheet with extracted document data, for example:
         ...
         ![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/zapier_spreadsheet.png) 
...
4. Wait a few minutes, then verify the extractions show up in your Google Drive folder as spreadsheets:
   ...
   ![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/zapier_action_3.png)

5. Verify the extractions show up in your optionally configured logs:

   ![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/zapier_action_4.png)
