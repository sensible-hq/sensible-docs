...
1. Create a test Slack channel. Name it `1040s_uploads`. Upload an [example 1040 document](https://raw.githubusercontent.com/sensible-configuration-library/main/templates/Tax%20Forms/1040s/refdocs/1040_2021_sample.pdf) to the channel.
