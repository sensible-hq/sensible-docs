...
2. Download an [example](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/pdfs/1040_2021_sample.pdf) 1040 tax form.
...
9. Follow the prompts to test the action. You should see the extracted data from the [1040 example document](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/pdfs/1040_2021_sample.pdf) as a row in Airtable:
