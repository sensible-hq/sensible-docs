...
* **API or SDK**:     
  ...
  * In a portfolio extraction API endpoint, specify the segmentation method and doc types, for example:
    ...
    --data '{
        "document_url":"https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/portfolio_bank_paystub_tax.pdf",
        "types": [
              "bank_statements",
              "pay_stubs",
              "1040s"
...
1. Follow the steps in [Out-of-the-box extractions](doc:library-quickstart)  to add support for the **bank statements**, **1040s**, and **pay stubs** document types to your account.
   ...
   **Note:** Each out-of-the-box document type comes preconfigured with a description in its **Description** field to enable LLM-based portfolio segmentation. The descriptions are as follows:
   ...
   ![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/portfolio_nav3.png)

2. Download the following example document:

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/portfolio_bank_paystub_tax.pdf) |
| ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/portfolio_nav_2.png) 
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/portfolio_nav.png)
...
| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/portfolio.pdf) |
| ---------------- | -------------------------------------------------------------------------------------------------------------------------- |
...
--header 'Content-Type: application/json' \
--data-raw '{"document_url":"https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/portfolio.pdf",
