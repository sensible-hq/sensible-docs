---
title: Split
excerpt: Learn how to use the Split computed field method to extract specific substrings
  from a field's string output by splitting on a delimiter.
deprecated: false
hidden: false
metadata:
  title: ''
  description: Learn how to use the Split computed field method to extract specific
    substrings from a field's string output by splitting on a delimiter.
  robots: index
next:
  description: ''
---
...
| :------------------------ | :------------------------------- | :----------------------------------------------------------------------------------------------------------------------------- |
| id (**required**)         | `split`                          |                                                                                                                                |
| source\_id (**required**) | a field id in the current config | The id of the field to split into substrings.                                                                                  |
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-docs/v0/assets/images/final/split.png)
