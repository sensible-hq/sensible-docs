...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/vertical_sections_labeled_rows.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/vertical_sections_labeled_rows.pdf) |
| ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
