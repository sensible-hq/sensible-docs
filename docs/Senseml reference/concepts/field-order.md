...
```json
{
    ...
    [
       {/* sections\_ID\_1 */},
       {/* sections\_ID\_2 */},
       {/* zip\_computed\_field\_ID that uses first two sections as sources */}, 
       {/* suppressOutput*computed\_field* that suppresses first two source sections for cleaner output */} 
    ]
