...
| match                    | A [Match](doc:match) object or array of Match objects | If specified, Sensible runs this preprocessor solely on pages containing the matched text. For example, use this parameter to target typewritten pages in a document that otherwise contains pages with digital fonts.                                                         |
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/split_lines_2.png)
...
![Click to enlarge](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/images/final/split_lines.png)

| Example document | [Download link](https://raw.githubusercontent.com/sensible-hq/sensible-documentation/v0/assets/pdfs/split_lines.pdf) |
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------- |
