...
| type (**required**)  | `equals`, `startsWith`, `endsWith`, `includes`          | `equals`: The matching line must equal the string<br/>`startsWith`: Line must start with the match<br/>`endsWIth`: Line must end with the match<br/>`includes`: Match can be anywhere in line                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
