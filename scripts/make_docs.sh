...
npx ts-node ~/Github/readme-sync/sync/index.ts --apiKey $LOCAL_ENV_README_API_KEY --version v0 --docs ~/Github/sensible-docs/readme-sync/v0 #npx ts-node ~/Github/readme-sync/sync/index.ts --apiKey $README_API_KEY --version v0 --docs ~/Github/sensible-docs/readme-sync/v0
